...
describe('v1.DomainsClient', () => {
    ...
    describe('searchDomains', () => {
        it('invokes searchDomains without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.SearchDomainsRequest());
            request.location = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.domains.v1.SearchDomainsResponse());
    ...
    describe('retrieveRegisterParameters', () => {
        it('invokes retrieveRegisterParameters without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.domains.v1.RetrieveRegisterParametersResponse());
    ...
    describe('retrieveTransferParameters', () => {
        it('invokes retrieveTransferParameters without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.RetrieveTransferParametersRequest());
            request.location = '';
            const expectedHeaderRequestParams = "location=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.domains.v1.RetrieveTransferParametersResponse());
    ...
    describe('getRegistration', () => {
        it('invokes getRegistration without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.GetRegistrationRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.domains.v1.Registration());
    ...
    describe('retrieveAuthorizationCode', () => {
        it('invokes retrieveAuthorizationCode without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.RetrieveAuthorizationCodeRequest());
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.domains.v1.AuthorizationCode());
    ...
    describe('registerDomain', () => {
        it('invokes registerDomain without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.RegisterDomainRequest());
            request.parent = '';
    ...
    describe('updateRegistration', () => {
        it('invokes updateRegistration without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.UpdateRegistrationRequest());
            request.registration = {};
    ...
    describe('configureManagementSettings', () => {
        it('invokes configureManagementSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.ConfigureManagementSettingsRequest());
            request.registration = '';
            const expectedHeaderRequestParams = "registration=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('configureContactSettings', () => {
        it('invokes configureContactSettings without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.ConfigureContactSettingsRequest());
            request.registration = '';
            const expectedHeaderRequestParams = "registration=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('exportRegistration', () => {
        it('invokes exportRegistration without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.ExportRegistrationRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteRegistration', () => {
        it('invokes deleteRegistration without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.DeleteRegistrationRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listRegistrations', () => {
        it('invokes listRegistrations without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.domains.v1.ListRegistrationsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
